...
*/
    ...
    var Ma = La,
        Na = function (a) {
            ...
            ya("javascript:" !== b, "%s is a javascript: URL", a) ||
...
*/
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    var y = window,
        ...
        C = function () {
            var a;
            if ((a = Object.create) && pb.test(a)) a = a(null);
            else {
                a = {};
    ...
    var I = function (a, b, c) {
        ...
        Kb = function (a, b) {
            ...
            a instanceof Pa && a.constructor === Pa
                ? (a = a.R)
                : (za(
    ...
    var Xc =
        ...
        $c = function () {
            ...
            null == a &&
                (a = (a = window.location.href.match(Yc)) ? a[1] : null);
            if (null == a) return null;
            a = String(a);
            21 < a.length && (a = null);
            return a;
    ...
    var ad,
        ...
        Cd = function (a) {
            if (-1 !== V)
                return Ad(), W ? t.JSON.stringify.call(t.JSON, a) : hd(a);
        },
        Dd =
    ...
    var Wd = {
        ...
        Xd = { allowtransparency: !0, onload: !0 },
        Yd = 0,
        Zd = function (a) {
        ...
        $d = function (a, b, c, d, e) {
            ...
            try {
                document.all &&
                    (f = a.createElement(
                        '<iframe frameborder="' +
                            xb(String(c.frameborder)) +
                            '" scrolling="' +
                            xb(String(c.scrolling)) +
                            '" ' +
                            k +
                            ' name="' +
                            xb(String(c.name)) +
                ...
                f ||
                    ((f = (a ? new mb(lb(a)) : va || (va = new mb())).ma(
                        "IFRAME"
                    )),
                    g &&
                        ((f.onload = function () {
            ...
            for (var h in c)
                (a = c[h]),
                    "style" === h && "object" === typeof a
                        ? E(a, f.style)
                        : Xd[h] || f.setAttribute(h, String(a));
    ...
    window.gapi.load("", {
        ...
        _c: {
            ...
            jsl: {
                ...
                h: "m;/_/scs/abc-static/_/js/k=gapi.lb.vi.saCGtT4DOq4.O/d=1/rs=AHpOoo-vGYBxEk-n7adgQZt5iQu80tf2rQ/m=__features__",
